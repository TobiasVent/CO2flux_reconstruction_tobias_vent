...
def preprocess_data(frac = 0.0001, out_dir = "/media/stu231428/1120 7818/Master_github/datasets",range_start=1958, range_end=1988):
    ...
    feature_means = time_series[feature_columns].mean()
    feature_stds = time_series[feature_columns].std()
    print("Applying z-normalization using calculated statistics...")
    time_series[feature_columns] = (time_series[feature_columns] - feature_means) / feature_stds
...
preprocess_data(frac=0.0001, out_dir="/media/stu231428/1120 7818/Master_github/datasets/training_set.pkl",range_start=1958, range_end=1959)
preprocess_data(frac=0.0001, out_dir="/media/stu231428/1120 7818/Master_github/datasets/validation_set.pkl", range_start=1989, range_end=1989)
